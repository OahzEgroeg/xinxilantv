...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_601150cf5bd8f=explode(',',$maccms['search_hot']); if(is_array($_601150cf5bd8f) || $_601150cf5bd8f instanceof \think\Collection || $_601150cf5bd8f instanceof \think\Paginator): if( count($_601150cf5bd8f)==0 ) : echo "" ;else: foreach($_601150cf5bd8f as $key2=>$vo2): ?>
