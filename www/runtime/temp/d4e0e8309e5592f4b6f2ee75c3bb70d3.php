...
<div class="header">
    ...
    <div id="searchbar">
        ...
        <div class="hotkeys">热搜：
            <?php $_60114e8d9e75e=explode(',',$maccms['search_hot']); if(is_array($_60114e8d9e75e) || $_60114e8d9e75e instanceof \think\Collection || $_60114e8d9e75e instanceof \think\Paginator): if( count($_60114e8d9e75e)==0 ) : echo "" ;else: foreach($_60114e8d9e75e as $key2=>$vo2): ?>
